        ...
        try {
            ...
            if ($empElg) {
                ...
                $hrimsConnection->table('hrm_employee_eligibility')->insert([
                  ...
                  'Mode_Travel_Outside_Hq'=>'Train',
                  'TravelClass_Outside_Hq'=>$empElg->Train_Class ?? 'Sleeper',
                    'Status' => 'A',
