    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-1">
                    <div class="col-3">
                        <h6 class="text-success">Candidate Joining Report</h6>
                    </div>
                    <div class="col-2">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover" id="MRFTable" style="width: 100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Reference No</th>
                                ...
                                <th>DOJ</th>
                                <th>Joining Form Filled</th>
                                <th>Document Verified</th>
                                <th>Data Fwd to ESS</th>
                                <th>Service Bond</th>
                                <th>Service Bond Years</th>
                                <th>Hiring From</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <script>
            $(document).ready(function() {
                $('#MRFTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('get_candidate_joining_report') }}",
                        headers: {
                    ...
                    columns: [{
                        ...
                        {
                            data: 'ServiceBondYears',
                            name: 'ServiceBondYears'
                        },
                        {
                            data: 'hiring_from',
                            name: 'hiring_from'
