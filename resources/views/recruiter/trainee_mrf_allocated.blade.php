...
@section('title', 'Trainee MRF Allocated')
@section('PageContent')
    <style>
        .table>:not(caption)>*>* {
            padding: 2px 1px;
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3 download_label">SIP / Trainee - Allocated MRF Details</div>
        </div>
        <!--end breadcrumb-->
        <hr />
        <div class="card">
...
@section('scriptsection')
    <script>
        ...
        $('#MRFTable').DataTable({
            ...
            ajax: {
                url: "{{ route('getAllTraineeAllocatedMrf') }}",
                headers: {
