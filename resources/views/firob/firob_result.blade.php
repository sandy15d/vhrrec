        ...
        <i>
            <table style="width:100%;top:100px;" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td align="center" colspan="5"><b>Final Result</b><br />
                        <table style="width:50%;" class=" table table-bordered">
                            ...
                            <tr>
                                ...
                                <td align="center"><input type="text" class="txtv" id="EI" /></td>

                                <td align="center"><input type="text" class="txtv" id="EC" /></td>

                                <td align="center"><input type="text" class="txtv" id="EA" /></td>
                            ...
                            <tr>
                                ...
                                <td align="center"><input type="text" class="txtv" id="WI" /></td>

                                <td align="center"><input type="text" class="txtv" id="WC" /></td>

                                <td align="center"><input type="text" class="txtv" id="WA" /></td>
                        ...
                        <table style="width:90%;font-style:normal;" border="0" cellpadding="2">
                            ...
                            <tr>
                                <td><b>EI:</b>Motivation, Team Building skills & Backup Style (Ability to enthuse
                                    & motivate people)<br />
                                    <div class="txtv2 " id="EIv" style="text-align: justify;"></div>
                                </td>
                            </tr>

                            <tr>
                                <td><b>WI:</b>Communication & Listening (Ability to listen & persuade)<br />
                                    <div class="txtv2" id="WIv" style="text-align: justify;"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><b>EC:</b>Dominant style, Decision Making profile (Ability to take
                                    ...
                                    <div class="txtv2" id="ECv" style="text-align: justify;"></div>
                                </td>
                            </tr>

                            <tr>
                                <td><b>WC:</b>Relations with Superiors (Acceptance of Authority))<br />
                                    <div class="txtv2" id="WCv" style="text-align: justify;"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><b>EA/WA:</b>Sense of Belongingness & Emotional Intelligence (A sense of
                                    ...
                                    <div class="txtv2" id="EAv" style="text-align: justify;"></div><br />
                                    <div class="txtv2" id="WAv" style="text-align: justify;"></div>
                                </td>
                            </tr>
                ...
                <script type="text/javascript" language="javascript">
                    ...
                    if (EI == 0 || EI == 1) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q1a").value;
                    } else if (EI == 2) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q2a").value;
                    } else if (EI == 3) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q3a").value;
                    } else if (EI == 4) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q4a").value;
                    } else if (EI == 5) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q5a").value;
                    } else if (EI == 6) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q6a").value;
                    } else if (EI == 7) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q7a").value;
                    } else if (EI == 8) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q8a").value;
                    } else if (EI == 9) {
                        document.getElementById("EIv").innerHTML = document.getElementById("EI_q9a").value;
                    }
                    ...
                    if (EC == 0 || EC == 1) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q1a").value;
                    } else if (EC == 2) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q2a").value;
                    } else if (EC == 3) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q3a").value;
                    } else if (EC == 4) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q4a").value;
                    } else if (EC == 5) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q5a").value;
                    } else if (EC == 6) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q6a").value;
                    } else if (EC == 7) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q7a").value;
                    } else if (EC == 8) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q8a").value;
                    } else if (EC == 9) {
                        document.getElementById("ECv").innerHTML = document.getElementById("EC_q9a").value;
                    }
                    ...
                    if (EA == 0 || EA == 1) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q1a").value;
                    } else if (EA == 2) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q2a").value;
                    } else if (EA == 3) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q3a").value;
                    } else if (EA == 4) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q4a").value;
                    } else if (EA == 5) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q5a").value;
                    } else if (EA == 6) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q6a").value;
                    } else if (EA == 7) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q7a").value;
                    } else if (EA == 8) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q8a").value;
                    } else if (EA == 9) {
                        document.getElementById("EAv").innerHTML = document.getElementById("EA_q9a").value;
                    }
                    ...
                    if (WI == 0 || WI == 1) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q1a").value;
                    } else if (WI == 2) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q2a").value;
                    } else if (WI == 3) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q3a").value;
                    } else if (WI == 4) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q4a").value;
                    } else if (WI == 5) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q5a").value;
                    } else if (WI == 6) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q6a").value;
                    } else if (WI == 7) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q7a").value;
                    } else if (WI == 8) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q8a").value;
                    } else if (WI == 9) {
                        document.getElementById("WIv").innerHTML = document.getElementById("WI_q9a").value;
                    }
                    ...
                    if (WC == 0 || WC == 1) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q1a").value;
                    } else if (WC == 2) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q2a").value;
                    } else if (WC == 3) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q3a").value;
                    } else if (WC == 4) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q4a").value;
                    } else if (WC == 5) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q5a").value;
                    } else if (WC == 6) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q6a").value;
                    } else if (WC == 7) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q7a").value;
                    } else if (WC == 8) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q8a").value;
                    } else if (WC == 9) {
                        document.getElementById("WCv").innerHTML = document.getElementById("WC_q9a").value;
                    }
                    ...
                    if (WA == 0 || WA == 1) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q1a").value;
                    } else if (WA == 2) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q2a").value;
                    } else if (WA == 3) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q3a").value;
                    } else if (WA == 4) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q4a").value;
                    } else if (WA == 5) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q5a").value;
                    } else if (WA == 6) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q6a").value;
                    } else if (WA == 7) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q7a").value;
                    } else if (WA == 8) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q8a").value;
                    } else if (WA == 9) {
                        document.getElementById("WAv").innerHTML = document.getElementById("WA_q9a").value;
                    }
                </script>
