...
<head>
    ...
    <title>VNR - Candidate Requisition Form</title>
    <style>
        .errorfield {
        ...
        <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-center mb-2">Requisition Form</h5>
                                <div id="smartwizard" class="sw sw-justified sw-theme-default">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link inactive active" href="#submit"> <strong>Final
                                                    Submit</strong></a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div id="personal" class="tab-pane" role="tabpanel"
                                            ...
                                            <div class="col-lg-8 mx-auto mt-4">
                                                <div class="col mx-auto">
                                                    <form action="{{ route('SaveRequisitionPersonalInfo') ?? ''}}" id="personal_form"
                                                        method="POST">
                                                        <div class="row">
                                                                ...
                                                                <div style="border: 1px solid #195999;vertical-align:top"
                                                                    ...
                                                                    <span id="preview">
                                                                        <center>
                                                                            ...
                                                                            @if (isset($Rec) && $Rec->CandidateImage != null)
                                        ...
                                        <div id="contact" class="tab-pane" role="tabpanel"
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-lg-12">
                                                    <form action="{{ route('SaveRequisitionContact') ?? ''}}" id="contact_form"
                                                        method="POST">
                                                        <div class="row">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <p><input type="checkbox" name="AddChk" id="AddChk" onclick="ticksameadd()">
                                                                    Tick if your
                                                ...
                                                <div class="col-lg-12 table-responsive">
                                                    <form id="ExperienceForm" action="{{ route('SaveExperience') ?? ''}}"
                                                        ...
                                                        <div style="text-align: center">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="ProfCheck" id="Fresher" onclick="showProFromOrNot('fres')" value="F"
                                                                    >
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-md-6">
                                                                            <input type="checkbox" name="TwoWheelChk"
                                                                                ...
                                                                                @php
                                                                                    if (isset($OtherDetail) && $OtherDetail != null) {
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->TwoWheelPetrolTerm ?? '') == 'Per KM') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                                                            <label
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                name="TwoWheelPetrolTerm"
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->TwoWheelPetrolTerm ?? '') == 'Per Month') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-md-6">
                                                                            <input type="checkbox" name="FourWheelChk"
                                                                                ...
                                                                                class="form-check-input"
                                                                                @php
                                                                                    if (isset($OtherDetail) && ($OtherDetail->FourWheelChk ?? 0) == 1) {
                                                                                        echo 'checked';
                                                                                    }
                                                                                @endphp> <label
                                                                                class="form-check-label"
                                                                            ...
                                                                            <table
                                                                                class="table table-bordered {{ (isset($OtherDetail) && ($OtherDetail->FourWheelChk ?? 0) == 1) ? '' : 'd-none' }}"
                                                                                id="fourwheel">
                                                                                <tr>
                                                                                    <td>Ownership Type</td>
                                                                                    <td>
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->FourWheelOwnerType ?? '') == 'W') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                name="FourWheelOwnerType"
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->FourWheelOwnerType ?? '') == 'C') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                                                            <label
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->FourWheelPetrolTerm ?? '') == 'Per KM') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                name="FourWheelPetrolTerm"
                                                                                                @php
                                                                                                    if (isset($OtherDetail) && ($OtherDetail->FourWheelPetrolTerm ?? '') == 'Per Month') {
                                                                                                        echo 'checked';
                                                                                                    }
                                                                                                @endphp>
                                                    ...
                                                    <div style="text-align: left">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input crime" type="radio"
                                                                ...
                                                                data-value="Y" @php
                                                                    if (isset($AboutAns) && $AboutAns != null) {
                                        ...
                                        <div id="other" class="tab-pane" role="tabpanel" aria-labelledby="step-2"
                                            ...
                                            <form action="{{ route('SaveOther') ?? ''}}" method="POST" id="OtherForm">
                                                @if (isset($Rec) && $Rec->Professional == 'P')
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <table class="table table-bordered">
                                                            <tr class="text-center">
                                                                <th>Name of Bank <span class="text-danger">*</span></th>
                                                                <th>Branch Name <span class="text-danger">*</span></th>
                                                                <th>Account Number <span class="text-danger">*</span></th>
                                                                <th>Bank IFSC <span class="text-danger">*</span></th>
                                                                <th>Document <span class="text-danger">*</span></th>
                                                                <th>View</th>
                                                            </tr>
                                                            <tr>
                                                                <td><input type="text" name="BankName" id="BankName"
                                                                        class="form-control form-control-sm"
                                                                        value="{{ $Rec->BankName ?? '' ?? ''}}"></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button class="btn btn-warning btn-sm d-inline"
                                                                        id="BankPassBookUpload">Upload</button>
                                                                </td>
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->BankDoc != null)
                                                        ...
                                                        <table class="table table-bordered text-center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 60%">
                                                                    ...
                                                                    <button class="btn btn-warning btn-sm d-inline"
                                                                        id="PANCardUpload">Upload</button>
                                                                </td>
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->PanCard != null)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button class="btn btn-warning btn-sm d-inline"
                                                                        id="PassportUpload">Upload</button>
                                                                </td>
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->Passport != null)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->Aadhar != null)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->BloodGroup != null)
                                                           ...
                                                           <td colspan="4" style="text-align:left">
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td style="width: 10%; text-align:center">
                                                                    @if (isset($Docs) && $Docs != null && $Docs->UAN != null)
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="DLCardUpload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->DL != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="PFForm2" id="PFForm2"
                                                                            ...
                                                                            style="width: 80%" accept="application/pdf">
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="PFForm2Upload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->PF_Form2 != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->PF_Form11 != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="GratuityForm"
                                                                            ...
                                                                            style="width: 80%" accept="application/pdf">
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="GratuityUpload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->Gratutity != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="ESICForm" id="ESICForm"
                                                                            ...
                                                                            style="width: 80%" accept="application/pdf">
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="ESICFormUpload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->ESIC != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->ESIC_Family != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="Health" id="Health"
                                                                            ...
                                                                            style="width: 80%" accept="application/pdf">
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="HealthUpload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->Health != null)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" name="Ethical" id="Ethical"
                                                                            ...
                                                                            style="width: 80%" accept="application/pdf">
                                                                        <button class="btn btn-warning btn-sm d-inline"
                                                                            id="EthicalUpload">Upload</button>
                                                                    </td>
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->Ethical != null)
                                                                ...
                                                                @if (isset($Rec) && ($Rec->emplyESIC ?? 0) > 0)
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 10%; text-align:center">
                                                                        @if (isset($Docs) && $Docs != null && $Docs->Family_Photo != null)
                                        ...
                                        <div id="submit" class="tab-pane" role="tabpanel" aria-labelledby="step-2"
                                            style="position: static; left: auto; width: 1017px; display: none;">
    ...
    <script>
        ...
        $(document).on('click', '.otherbenefit', function() {
            if ($(this).prop('checked')) {
                $('#' + $(this).data('payload')).addClass('reqinp_exp').prop('', false);
            } else {
                $('#' + $(this).data('payload')).removeClass('reqinp_exp').prop('', true);
            }
        });
                        ...
                        success: function(data) {
                            if (data.status == 400) {
                                ...
                                toastr.error(data.msg);
                                 ...
                                 $('#JCId').val(data.JCId);
                                 localStorage.setItem('JCId', data.JCId);
                                 window.location.href ="/candidate-requisition-form?JCId=" + data.JCId + "#contact";
        ...
        $(document).ready(function () {
            ...
            }else if (window.location.hash == '#document') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 400) {
                        ...
                        window.location.href = "/candidate-requisition-form?JCId=" + $('#JCId').val() + "#document";
        ...
        $(document).on('click', '#final_submit', function() {
            var url = '<?= route('RequisitionFormSubmit') ?>';
            $.post(url, {
                JCId: $('#JCId').val()
            }, function(data) {
                if (data.status == 200) {
                    ...
                    window.location.href = "/candidate-requisition-form";
                } else {
                    toastr.error(data.msg);
                }
            }, 'json');
