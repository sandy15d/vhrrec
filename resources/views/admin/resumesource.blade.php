...
@section('PageContent')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Resume Source Master</div>
            <div class="ms-auto">
                <button class="btn btn--new btn-sm" id="addResumeSource" data-bs-toggle="modal"
                    data-bs-target="#addResumeSourceModal">Add New</button>
            </div>
        </div>
        <!--end breadcrumb-->
        <hr />
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-condensed" id="resumesourcetable"
                        style="width: 100%">
