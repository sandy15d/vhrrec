...
@section('PageContent')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Education Specialization Master</div>
            <div class="ms-auto">
                <button class="btn btn--new btn-sm" id="addEduSpe" data-bs-toggle="modal"
                    data-bs-target="#addEduSpeModal">Add New</button>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-condensed" id="EduSpeTable" style="width: 100%">
