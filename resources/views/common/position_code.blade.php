        ...
        <div class="page-breadcrumb  align-items-center">
            <div class="row mb-1">
                ...
                <div class="col-2">
                    ...
                    <button class="btn btn-sm btn--red" id="SyncPositionCode" style="margin-left: 50px;">Sync</button>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col" style="text-align: right">
                        <button class="btn btn-success px-1 btn-sm" style="text-align: right" data-bs-toggle="modal"
                        data-bs-target="#addPositionModal">New</button>
                    </div>
