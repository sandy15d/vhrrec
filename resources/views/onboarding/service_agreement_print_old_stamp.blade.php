        ...
        <div id="ServiceAgreement_ltr">
            ...
            <div class="page">
                <div class="subpage ml-3">
                    ...
                    <p style="text-align: justify"><b>{{ $sql->Title }} {{ $sql->FName }} {{ $sql->MName }}
                        ...
                        <b> {{ $sql->perm_address }}, {{ $sql->perm_city }},
                    ...
                    <p style="text-align: justify">WHERE AS the company has selected the Employee on the post of
                        ...
                        <b>Grade-{{ getGradeValue($sql->Grade) }}</b>, in the Company as per the term and conditions
                        Stipulated in the letter
                        of appointment dated {{ date('d-m-Y', strtotime($sql->A_Date)) }} and the employee has agreed to
                        abide with the terms and conditions of
                        his employment.
                    </p>
            ...
            <div class="page">
                <div class="subpage">
                    ...
                    <p style="text-align: justify; margin-top:30px;">I <b>{{ $sql->Title }} {{ $sql->FName }}
                            {{ $sql->MName }}
                            {{ $sql->LName }},</b> {{ $sql->Gender == 'M' ? 'S/o' : 'D/o' }}
                        <b>{{ $sql->FatherTitle }}
                        ...
                        of all such terms & conditions, I further acknowledge and agree as follows:
                    </p>
                    <ol>
                        <li>
