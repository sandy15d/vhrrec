...
<p style="text-align: justify"><b>WHEREAS</b> the Company has offered and the Employee has accepted
    ...
    dated <!--{{ date('d-m-Y', strtotime($sql->A_Date)) }} --> &emsp;&emsp;&emsp;&emsp; and the Employee has
    agreed to abide with
    the
...
<ol type="1">
    ...
    <li>The Employee by his/her own free will, discretion and judgement, agrees and undertakes to
        serve the Company continuously for a minimum period of <b>{{ $months_word[$sql->ServiceBondYears] }}
            years </b> from
