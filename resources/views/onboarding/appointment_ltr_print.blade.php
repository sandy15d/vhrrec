            ...
            <tr>
                <td>
                    ...
                    <div class="page">
                       ...
                       <p><b>To,</b></p>
                    <p style="margin-bottom: 0px;"><b>{{ $sql->Title }} {{ $sql->FName }} {{ $sql->MName }} {{ $sql->LName }}</b> </p>
                                ...
                                <li>
                                    ...
                                    <ol type="a">
                                        <li>
                                            ...
                                            months
                                            from the Appointment Date (<strong>“{{ $sql->ServiceCondition }} Date”</strong>) which maybe
                                            either
                                            extended or may
                                            be
        ...
        <tfoot>
            <tr>
                <td>
                    ...
                    <div class={{ $sql->Company == 1 ? 'page-footer-space' : 'page-footer-space-vnpl' }}>

                        <p style="margin-bottom:2px;margin-top: 5px;">----------------------------<span
                                style="float: right">----------------------------</span></p>
                        <p style="margin-top: 10px;"><b>Authorized Signatory,<span style="float: right">
                                     {{ $sql->FName }} {{ $sql->MName }}
                                    {{ $sql->LName }}</span></b></p>
