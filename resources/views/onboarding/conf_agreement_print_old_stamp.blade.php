...
<body>
    ...
    <ol type="a">
        <li> The company has selected the Employee for the post
            <b>{{ getDesignation($sql->Designation) }}</b> at
            <b>Grade-{{ getGradeValue($sql->Grade) }}</b>, in the
            Company as per the terms and conditions stipulated in the letter of appointment dated
            <b>{{ date('d-m-Y', strtotime($sql->JoinOnDt)) }}</b> and the Employee has agreed to
            abide
    ...
    <p class="abc"><span>1.3</span> <span><b>“Applicable Laws”</b> shall mean all laws of
            India,
    ...
    <p class="abc"><span>1.5</span> <span><b>“Effective date”</b> shall mean the date of
            execution
            of this Agreement;</span></p>
    <p class="abc"><span>1.6</span> <span><b>“Exempted Information"</b> means information
            that the
    ...
    <p class="abc"><span>1.7</span> <span><b>“Governmental Authority”</b> shall mean any
            national,
            ...
            <p class="abc"><span>1.8</span> <span><b>“Intellectual Property”</b> means and includes,
                    in
            ...
            <p class="abc"><span>1.9</span> <span><b>“Intellectual Property Rights”</b> shall mean
                    and
                    include: </span></p>
            <ul type="none">
                <li>
            ...
            <p class="abc"><span>1.10</span> <span><b>“Plant Propagation Material”</b> means the
                    varieties
            ...
            <p><b>6. GENERAL</b></p>
            <p class="abc"><span>6.1 </span> <span><b><u>Notice:</u></b> Notices and all other
                    communications
                    ...
                    agreement.</span></p>
            <p class="abc"><span>6.2 </span> <span><b><u>Waiver:</u></b> No provision of this
                    agreement shall be
            ...
            <p class="abc"><span>6.3 </span> <span><b><u>Dispute Resolution, Governing Law, and
                            Jurisdiction:</u></b> This Agreement shall be governed by the laws of India and any
                    court of
            ...
            <p class="abc"><span>6.4 </span> <span><b><u>Attorneys’ Fees:</u></b> In any litigation
                    to enforce the
            ...
            <p style="margin-bottom: 0px;"><b>Authorized Signatory</b>
                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span
                    style="text-align: right"><strong> {{ $sql->FName }}
                        {{ $sql->MName }}
